...
datas = [
    ...
    (str(project_root / 'ai' / 'categories.json'), 'ai'),
...
hiddenimports = [
    ...
    'database.migrations.v002_performance_indexes',
    'database.repositories.app_session_repo',
    'database.repositories.browser_session_repo',
    'database.repositories.category_rule_repo',
    'database.repositories.summary_repo',
    'database.repositories.youtube_repo',
    'database.repositories.battery_repo',
    'database.repositories.limit_repo',
    'database.repositories.water_repo',
    'database.repositories.settings_repo',
    'database.repositories.process_repo',
    'ai.rules_engine',
    'ai.productivity_scorer',
    'ai.insights_generator',
    'utils.autostart',
    'utils.logger',
    'tray_app',
    'webview',
