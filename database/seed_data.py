...
DEFAULT_CATEGORY_RULES: List[Tuple[str, str, str, str, str, int]] = [
    ...
    ("domain", "in.indeed.com", CATEGORY_JOB_SEARCH, "portal", PRODUCTIVITY_PRODUCTIVE, 90),
    ...
    ("domain", "arena.ai", CATEGORY_LEARNING, "ai_tools", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "lmarena.ai", CATEGORY_LEARNING, "ai_tools", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "lmsys.org", CATEGORY_LEARNING, "ai_tools", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "chat.lmsys.org", CATEGORY_LEARNING, "ai_tools", PRODUCTIVITY_PRODUCTIVE, 100),
    ...
    ("domain", "web.whatsapp.com", CATEGORY_COMMUNICATION, "chat", PRODUCTIVITY_NEUTRAL, 80),
    ("domain", "swayam.gov.in", CATEGORY_LEARNING, "course", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "swayam2.ac.in", CATEGORY_LEARNING, "course", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "onlinecourses.nptel.ac.in", CATEGORY_LEARNING, "course", PRODUCTIVITY_PRODUCTIVE, 100),
    ("domain", "piax.org", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 95),
    ("domain", "kie.ai", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 95),
    ("domain", "v0.app", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 95),
    ("domain", "music.youtube.com", CATEGORY_MUSIC, "streaming", PRODUCTIVITY_NEUTRAL, 90),
    ...
    ("title_pattern", "linkedin", CATEGORY_JOB_SEARCH, "portal", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "whatsapp", CATEGORY_COMMUNICATION, "chat", PRODUCTIVITY_NEUTRAL, 110),
    ("title_pattern", "swayam", CATEGORY_LEARNING, "course", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "nptel", CATEGORY_LEARNING, "course", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "youtube music", CATEGORY_MUSIC, "streaming", PRODUCTIVITY_NEUTRAL, 110),
    ...
    ("title_pattern", "piax", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "kie.ai", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "v0 by vercel", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "experiential", CATEGORY_CODING, "ai_assist", PRODUCTIVITY_PRODUCTIVE, 110),
    ...
    ("title_pattern", "operating system", CATEGORY_LEARNING, "computer_science", PRODUCTIVITY_PRODUCTIVE, 110),
    ("title_pattern", "computer networks", CATEGORY_LEARNING, "computer_science", PRODUCTIVITY_PRODUCTIVE, 110),
